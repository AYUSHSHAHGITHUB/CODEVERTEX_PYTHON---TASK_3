...
root.title('AYUSH SHAH CONTACT BOOK')
root.resizable(0,0)
contactlist = [

    ['AYUSH SHAH ','8799146289'],
    ['ARJUN PADHIYAR', '8140010930K'],
    ['PARTIK CHAUHAN', '9624433423'],
    ['NARSI SOLANKI', '9824848616'],
    ['SWAYAM VASAVADA', '8849014271'],
    ['DEV PATEL', '9725580988'],
    ['RIYA PARMAR', '9726345409'],
    ['DRASHTI PATEL', '8490923364'],
    ['DEVANSHI PARMAR', '9484638377'],
    ['DHWANI SHAH', '9724219806'],
    ['PARESH SHAH', '9228876645'],
...
Button(root,text=" ADD", font='Helvetica 18 bold',bg='#0000FF', command = AddContact, padx=20). place(x= 50, y=140)
Button(root,text="EDIT", font='Helvetica 18 bold',bg='#0000FF',command = UpdateDetail, padx=20).place(x= 50, y=200)
Button(root,text="DELETE", font='Helvetica 18 bold',bg='#0000FF',command = Delete_Entry, padx=20).place(x= 50, y=260)
Button(root,text="VIEW", font='Helvetica 18 bold',bg='#0000FF', command = VIEW).place(x= 50, y=325)
Button(root,text="RESET", font='Helvetica 18 bold',bg='#0000FF', command = EntryReset).place(x= 50, y=390)
